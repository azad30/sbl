        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit ItemCategory #{{ $itemcategory->id }}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::model($itemcategory, [
                            'method' => 'PATCH',
                            'url' => ['/itemcategories/item-category', $itemcategory->id],
                            'class' => 'form-horizontal',
                            'files' => true
                        ]) !!}

                        @include ('item-category.form', ['submitButtonText' => 'Update'])
